...
const QUICK_ACTIONS: QuickAction[] = [
  {
    ...
    label: "Buyer Consult",
    icon: Phone,
    prompt: "Help me prepare for a first buyer consultation. Give me a simple agenda, discovery questions, document checklist, and follow-up email I can personalize. Keep it educational and do not make approval or rate promises.",
    color: "text-accent-gold",
  },
  {
    id: "preapproval_checklist",
    label: "Preapproval Checklist",
    icon: UserCheck,
    prompt: "Create a borrower-friendly preapproval checklist with documents to gather, common delays, and a short text message asking for missing items. Keep it plain English.",
    color: "text-status-ok",
  },
  {
    id: "realtor_outreach",
    label: "Realtor Outreach",
    icon: Users,
    prompt: "Draft a helpful realtor partner outreach message offering a buyer education resource or co-hosted first-time homebuyer class. Keep it short, specific, and not salesy.",
  ...
  },
  {
    ...
    icon: Zap,
    prompt: "Help me run a weekly loan officer pipeline review. Give me a simple table for hot leads, stuck files, realtor touches, next calls, and follow-up drafts.",
    color: "text-[#EA4B71]",
  },
  {
    id: "social_draft",
    label: "Social Draft",
    icon: FileText,
    prompt: "Create a draft-only educational social post for first-time homebuyers. Include a short caption, optional video script, and compliant CTA. No rates, payments, guarantees, or approval promises.",
    color: "text-accent-gold",
  },
];
