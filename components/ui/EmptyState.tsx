    ...
    <div className="card flex flex-col items-center justify-center gap-4 p-10 text-center">
      {Icon && (
        <div className="relative grid h-14 w-14 place-items-center">
          ...
          />
          <span className="relative grid h-10 w-10 place-items-center rounded-full border border-accent-gold/30 bg-ink-100/70 text-accent-orange shadow-[inset_0_1px_0_0_rgba(255,255,255,0.05)] dark:bg-ink-900/70 dark:text-accent-gold">
            <Icon size={18} />
          </span>
        </div>
      )}
