...
export function TopBar({ profile }: { profile: Profile }) {
  ...
  return (
    <header className="theme-shell desktop-titlebar-drag desktop-mac-traffic-offset relative z-20 flex shrink-0 items-center justify-between gap-4 border-b border-ink-900/10 px-5 py-3 dark:border-accent-champagne/10">
      <span
        aria-hidden
