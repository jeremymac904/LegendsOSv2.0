...
export const trackers: TrackerConfig[] = [
  ...
  },
  {
    ...
    tab: "Database",
    subtitle:
      "Work your sphere on a rhythm — every contact has a relationship, a last touch, and a next touch date.",
    addLabel: "Add contact",
    csvName: "database-tracker.csv",
    columns: [
      { key: "contact", label: "Contact", kind: "text", minWidth: "11rem" },
      {
        ...
        label: "Relationship",
        kind: "select",
        options: ["Past client", "Sphere", "Friend / family", "Prospect", "Partner"],
        minWidth: "10rem",
      },
      { key: "lastTouch", label: "Last touch", kind: "date", minWidth: "9rem" },
      {
        ...
        label: "Touch type",
        kind: "select",
        options: ["Call", "Text", "Email", "Handwritten note", "Gift", "Event"],
        minWidth: "9rem",
      },
      { key: "nextTouch", label: "Next touch due", kind: "date", minWidth: "9rem" },
      { key: "nextAction", label: "Next action", kind: "text", minWidth: "12rem" },
      { key: "notes", label: "Notes", kind: "long", minWidth: "13rem" },
    ],
  },
  ...
  {
    key: "past-client",
    title: "Past Client Tracker",
    tab: "Past Clients",
    subtitle:
      "Retention and repeat business — annual reviews, equity opportunities, and the referral ask for every closed client.",
    addLabel: "Add past client",
    csvName: "past-client-tracker.csv",
    columns: [
      { key: "client", label: "Client", kind: "text", minWidth: "11rem" },
      { key: "closeDate", label: "Close date", kind: "date", minWidth: "9rem" },
      { key: "loanType", label: "Loan type", kind: "text", minWidth: "8rem" },
      { key: "lastReview", label: "Last review", kind: "date", minWidth: "9rem" },
      { key: "nextReview", label: "Next review due", kind: "date", minWidth: "9rem" },
      {
        key: "opportunity",
        label: "Equity opportunity",
        kind: "select",
        options: ["Rate/term refi", "Cash-out", "HELOC", "Move-up", "Investment", "None yet"],
        minWidth: "11rem",
      },
      {
        key: "referralAsked",
  ...
  },
  {
    ...
    tab: "Referrals",
    subtitle:
      "Every referral in and out — the source, the status, and whether the thank-you went back.",
    addLabel: "Add referral",
    csvName: "referral-tracker.csv",
    columns: [
      { key: "name", label: "Referred contact", kind: "text", minWidth: "11rem" },
      { key: "source", label: "Source / who referred", kind: "text", minWidth: "12rem" },
      {
        key: "direction",
        label: "Direction",
        kind: "select",
      ...
      { key: "dateReceived", label: "Date", kind: "date", minWidth: "9rem" },
      {
        key: "status",
        label: "Status",
        kind: "select",
        options: ["New", "Contacted", "Application", "Pre-approved", "Under contract", "Closed", "Lost"],
        minWidth: "11rem",
      },
      {
        key: "thankYou",
